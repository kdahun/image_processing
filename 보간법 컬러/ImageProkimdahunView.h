...
// ImageProkimdahunView.h: CImageProkimdahunView 클래스의 인터페이스
//
...
public:
	...
	afx_msg void OnDilattion();
	afx_msg void OnOpening();
	afx_msg void OnClosing();
	afx_msg void OnGeometryZoominPixelCopy();
	afx_msg void OnGeometryXoominInterpolation();
	void GeometryZoomminInterpolation();
};
